    ...
    try {
      ...
      const mappedPost: Post = {
        ...
        user: {
          ...
          team: postData.user.team,
          followers: postData.user.followers_count || 0,
          following: postData.user.following_count || 0,
          posts: postData.user.posts_count || 0,
          createdAt: postData.user.created_at || new Date().toISOString(),
        },
        ...
        celebrations: postData.celebrations_count,
        golazos: postData.golazos_count,
        laughs: 0,
        comments: [],
