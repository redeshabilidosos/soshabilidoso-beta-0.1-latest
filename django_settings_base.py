...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='sos_habilidoso_db'),
        'USER': config('DATABASE_USER', default='sos_admin'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para la red social de fútbol SOS-HABILIDOSO',
    'VERSION': '1.0.0',
...
# Phone Number Field
PHONENUMBER_DEFAULT_REGION = 'CO'  # Colombia